...
func (p *MoneatProvider) Resources(_ context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		NewWorkflowResource,
		NewConnectorInstallationResource,
		NewConnectionGroupResource,
		NewWorkflowScheduleResource,
		NewWorkflowGrantResource,
		NewWorkflowExecutionIdentityResource,
		NewWorkflowOrganizationPolicyResource,
...
func (p *MoneatProvider) DataSources(_ context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		NewWorkflowCatalogDataSource,
		NewWorkflowBlueprintDataSource,
		NewConnectorProvidersDataSource,
		NewConnectorInstallationsDataSource,
		NewConnectorGroupsDataSource,
		NewConnectorResourcesDataSource,
